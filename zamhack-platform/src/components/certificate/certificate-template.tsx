...
const CompletionCertificate = forwardRef<HTMLDivElement, CompletionCertificateProps>(
  ({ studentName, challengeTitle, organizationName, completionDate, totalScore }, ref) => {
    return (
      <div
        ref={ref}
        style={{
        ...
        <div style={{
          ...
          <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: "4px" }}>
            <div style={{ width: "56px", height: "56px", borderRadius: "50%",
              ...
              display: "flex", alignItems: "center", justifyContent: "center",
              border: "3px solid #FF9B87", boxShadow: "0 4px 16px rgba(44,62,80,0.25)" }}>
              <svg width="28" height="28" viewBox="0 0 20 20" fill="none">
                <path d="M10 2L12.5 7.5H18L13.5 11L15.5 17L10 13.5L4.5 17L6.5 11L2 7.5H7.5L10 2Z" fill="#FF9B87" />
              </svg>
            </div>
            <span style={{ fontSize: "9px", color: "#7A909E", letterSpacing: "0.10em",
              textTransform: "uppercase" }}>Official Seal</span>
          </div>

          <div style={{ textAlign: "right" }}>
            <div style={{ width: "160px", height: "1px", background: "#2C3E50",
              marginBottom: "4px", marginLeft: "auto" }} />
            <div style={{ fontSize: "11px", color: "#7A909E", letterSpacing: "0.05em" }}>
              ZamHack Platform
            </div>
          </div>
        </div>
